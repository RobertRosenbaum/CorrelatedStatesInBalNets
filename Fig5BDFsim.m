...
SxSxth=(zeros(Nx,Nx)+(rx-c*rx)*eye(Nx)+c*rx)*winsize;
CXXth=Jx*SxSxth*Jx';
...
save Fig5BDFsim.mat N T LRerrrmg LRerrr mCthmg vCthmg mLHS mRHS mLHSmg mRHSmg vLHS vRHS vLHSmg vRHSmg vC vCth Cthmgplot RHSmgplot LHSmgplot RHSplot LHSplot mg mC mCth Cthhist Cthedges Chist Cedges T numtrials errr ccoef Cplot Cthplot GeoMeanRatesplot nplot;
