...
E3plot=IeRec(3,timeRecord>=t1plot & timeRecord<=t2plot);
E4plot=IeRec(4,timeRecord>=t1plot & timeRecord<=t2plot);
I1plot=IiRec(1,timeRecord>=t1plot & timeRecord<=t2plot);
I2plot=IiRec(2,timeRecord>=t1plot & timeRecord<=t2plot);
I3plot=IiRec(3,timeRecord>=t1plot & timeRecord<=t2plot);
I4plot=IiRec(4,timeRecord>=t1plot & timeRecord<=t2plot);
X1plot=IxRec(1,timeRecord>=t1plot & timeRecord<=t2plot);
X2plot=IxRec(2,timeRecord>=t1plot & timeRecord<=t2plot);
X3plot=IxRec(3,timeRecord>=t1plot & timeRecord<=t2plot);
X4plot=IxRec(4,timeRecord>=t1plot & timeRecord<=t2plot);

S1plot=s(:,s(1,:)>=t1plot & s(1,:)<=t2plot & s(2,:)<=nsplot);
S2plot=s(:,s(1,:)>=t1plot & s(1,:)<=t2plot & s(2,:)<=Ne & s(2,:)>Ne-nsplot);
Sxplot=sx(:,sx(1,:)>=t1plot & sx(1,:)<=t2plot & sx(2,:)<nsplot);

save Fig7sim.mat nsplot plottime E1plot E2plot I1plot I2plot X1plot X2plot E3plot E4plot I3plot I4plot X3plot X4plot S1plot S2plot Sxplot t1plot t2plot;
