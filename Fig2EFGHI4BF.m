...
plot(Nrange,TSCovEE+0*Nrange,'--','Color',eeclr,'LineWidth',lw)
plot(Nrange,TSCovEI+0*Nrange,'--','Color',eiclr,'LineWidth',lw)
plot(Nrange,TSCovII+0*Nrange,'--','Color',iiclr,'LineWidth',lw)
xlabel('network size (N)')
